...
import com.onlineshopping.service.SequenceGeneratorService;
...
public class UserController {
	...
	public ResponseEntity<?> registerUser(@RequestBody AddUserRequest userRequest) {
		...
		address.setId(sequenceGeneratorService.getSequenceNumber(Address.ADDRESS_SEQUENCE_NAME));
		...
		User user = new User();
		user.setId(sequenceGeneratorService.getSequenceNumber(User.USERS_SEQUENCE_NAME));
